...
async function createTestData() {
  try {
    ...
    const testManuscript = await Manuscript.create({
      ...
      abstract: 'This paper presents a comprehensive study on the application of neural networks in medical diagnosis, focusing on image recognition and pattern analysis.',
